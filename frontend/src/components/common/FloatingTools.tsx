                ...
                <div className="flex flex-col items-center space-y-3 mb-4 z-[999]">
                    {tools.map((tool, index) => (
                        <button
                            ...
                            className="w-14 h-14 rounded-full bg-[rgba(15,10,30,0.75)] backdrop-blur-xl border border-accent-primary/35 text-white flex items-center justify-center shadow-[0_0_20px_rgba(124,58,237,0.35)] transition-all duration-300 hover:bg-accent-primary hover:shadow-[0_0_25px_rgba(139,92,246,0.55)] animate-fade-in"
