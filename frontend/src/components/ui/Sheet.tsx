...
const Sheet = ({ open, onOpenChange, children, side = "right" }: { open: boolean; onOpenChange: (open: boolean) => void; children: React.ReactNode; side?: "top" | "right" | "bottom" | "left" }) => {
  ...
  return (
    <div className="fixed inset-0 z-50">
      ...
      <div className={cn("fixed z-50 glass shadow-[0_0_25px_rgba(124,58,237,0.25)] backdrop-blur-xl transition-transform duration-300", sideClasses[side], positionClasses[side])}>
        <button
