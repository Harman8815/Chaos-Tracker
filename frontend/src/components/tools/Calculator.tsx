...
const Calculator: React.FC = () => {
    ...
    const HelpOverlay = () => (
        <div className="absolute inset-0 bg-[rgba(15,10,30,0.75)]/95 backdrop-blur-sm p-4 z-10 flex flex-col animate-fade-in text-sm text-text-secondary">
            <div className="flex justify-between items-center mb-4">
                <h3 className="font-bold text-lg text-white">Calculator Help</h3>
                <button onClick={() => setShowHelp(false)} className="w-8 h-8 rounded-full bg-white/[0.06] flex items-center justify-center hover:bg-[rgba(139,92,246,0.35)] text-lg">&times;</button>
            </div>
    ...
    const renderStandardButtons = () => (
        <div className="grid grid-cols-4 gap-2">
            ...
            <button title="Backspace: Deletes the last character" onClick={handleBackspace} className="bg-white/[0.06] hover:bg-[rgba(139,92,246,0.35)] text-white backdrop-blur-sm border border-white/5 p-3 rounded-lg transition-all duration-200">C</button>
            <button title="Divide" onClick={() => handleOperator('/')} className="bg-white/[0.06] hover:bg-[rgba(139,92,246,0.35)] text-white backdrop-blur-sm border border-white/5 p-3 rounded-lg transition-all duration-200">/</button>
            {'789'.split('').map(n => <button key={n} title={`Number ${n}`} onClick={() => handleInput(n)} className="bg-white/[0.06] hover:bg-[rgba(139,92,246,0.35)] text-white backdrop-blur-sm border border-white/5 p-3 rounded-lg transition-all duration-200">{n}</button>)}
            <button title="Multiply" onClick={() => handleOperator('*')} className="bg-white/[0.06] hover:bg-[rgba(139,92,246,0.35)] text-white backdrop-blur-sm border border-white/5 p-3 rounded-lg transition-all duration-200">*</button>
            {'456'.split('').map(n => <button key={n} title={`Number ${n}`} onClick={() => handleInput(n)} className="bg-white/[0.06] hover:bg-[rgba(139,92,246,0.35)] text-white backdrop-blur-sm border border-white/5 p-3 rounded-lg transition-all duration-200">{n}</button>)}
            <button title="Subtract" onClick={() => handleOperator('-')} className="bg-white/[0.06] hover:bg-[rgba(139,92,246,0.35)] text-white backdrop-blur-sm border border-white/5 p-3 rounded-lg transition-all duration-200">-</button>
            {'123'.split('').map(n => <button key={n} title={`Number ${n}`} onClick={() => handleInput(n)} className="bg-white/[0.06] hover:bg-[rgba(139,92,246,0.35)] text-white backdrop-blur-sm border border-white/5 p-3 rounded-lg transition-all duration-200">{n}</button>)}
            <button title="Add" onClick={() => handleOperator('+')} className="bg-white/[0.06] hover:bg-[rgba(139,92,246,0.35)] text-white backdrop-blur-sm border border-white/5 p-3 rounded-lg transition-all duration-200">+</button>
            <button title="Number 0" onClick={() => handleInput('0')} className="bg-white/[0.06] hover:bg-[rgba(139,92,246,0.35)] text-white backdrop-blur-sm border border-white/5 p-3 rounded-lg transition-all duration-200">0</button>
            <button title="Decimal Point" onClick={() => handleInput('.')} className="bg-white/[0.06] hover:bg-[rgba(139,92,246,0.35)] text-white backdrop-blur-sm border border-white/5 p-3 rounded-lg transition-all duration-200">.</button>
    ...
    const renderFinanceButtons = () => (
        <div className="grid grid-cols-3 gap-2 text-sm flex-grow">
            <button title="Number of Periods" onClick={() => handleFinanceKey('N')} className="bg-white/[0.06] hover:bg-[rgba(139,92,246,0.35)] text-white backdrop-blur-sm border border-white/5 p-2 rounded-lg transition-all duration-200">N</button>
            <button title="Interest Rate per Year" onClick={() => handleFinanceKey('IY')} className="bg-white/[0.06] hover:bg-[rgba(139,92,246,0.35)] text-white backdrop-blur-sm border border-white/5 p-2 rounded-lg transition-all duration-200">I/Y</button>
            <button title="Present Value" onClick={() => handleFinanceKey('PV')} className="bg-white/[0.06] hover:bg-[rgba(139,92,246,0.35)] text-white backdrop-blur-sm border border-white/5 p-2 rounded-lg transition-all duration-200">PV</button>
            <button title="Payment per Period" onClick={() => handleFinanceKey('PMT')} className="bg-white/[0.06] hover:bg-[rgba(139,92,246,0.35)] text-white backdrop-blur-sm border border-white/5 p-2 rounded-lg transition-all duration-200">PMT</button>
            <button title="Future Value" onClick={() => handleFinanceKey('FV')} className="bg-white/[0.06] hover:bg-[rgba(139,92,246,0.35)] text-white backdrop-blur-sm border border-white/5 p-2 rounded-lg transition-all duration-200">FV</button>
    ...
    return (
        <div className="relative flex flex-col font-mono text-white text-lg bg-white/[0.06] backdrop-blur-sm border border-white/5 rounded-2xl">
             {showHelp && <HelpOverlay />}
             <div className="flex justify-between items-center mb-2 px-3 pt-3">
                <div className="flex items-center gap-2">
                    <button 
                        onClick={() => setShowHelp(true)} 
                        className="w-5 h-5 rounded-full border border-text-secondary text-text-secondary flex items-center justify-center text-xs font-bold hover:bg-[rgba(139,92,246,0.35)] hover:text-white"
                        title="Show Help"
                    >
                        i
                    </button>
                    <span className="text-xs text-text-secondary font-medium">Finance Mode</span>
                </div>
                <button
                    onClick={() => {}}
