    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-[rgba(15,10,30,0.75)] rounded-lg shadow-xl w-full max-w-md mx-4 max-h-[90vh] overflow-y-auto">
                <div className="flex items-center justify-between p-6 border-b border-[rgba(139,92,246,0.35)]">
                    <h2 className="text-xl font-semibold text-white">Add Activity</h2>
                    <Button 
                        onClick={handleClose} 
                        className="bg-[rgba(15,10,30,0.6)] text-white hover:bg-[rgba(139,92,246,0.35)]"
                    >
                        ×
                    </Button>
                </div>
                ...
                <form onSubmit={handleSubmit} className="p-6">
                                ...
                                <button
                                    ...
                                    className={`p-3 rounded-lg border-2 transition-all ${
                                        activityType === type.value
                                            ? 'border-[rgba(139,92,246,0.35)] bg-[rgba(139,92,246,0.10)]'
                                            : 'border-[rgba(139,92,246,0.35)] hover:border-[rgba(139,92,246,0.35)] hover:bg-[rgba(139,92,246,0.35)]'
                                    }`}
                                >
                    ...
                    <div className="mb-4">
                        ...
                        <input
                            ...
                            className="w-full p-3 rounded-lg border border-[rgba(139,92,246,0.35)] bg-[rgba(15,10,30,0.6)] text-white focus:outline-none focus:ring-2 focus:ring-accent-primary"
                            required
                        />
                    </div>
                    ...
                    {activityType === 'journal' && (
                        <div className="mb-4">
                            ...
                            <textarea
                                ...
                                rows={4}
                                className="w-full p-3 rounded-lg border border-[rgba(139,92,246,0.35)] bg-[rgba(15,10,30,0.6)] text-white focus:outline-none focus:ring-2 focus:ring-accent-primary resize-none"
                                required
                            />
                        </div>
                    )}
                    ...
                    {/* Form Actions */}
                    <div className="flex justify-end gap-3 pt-4 border-t border-[rgba(139,92,246,0.35)]">
                        <Button
                            type="button"
                            onClick={handleClose}
                            className="bg-[rgba(15,10,30,0.6)] text-white hover:bg-[rgba(139,92,246,0.35)]"
