        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-background rounded-lg shadow-xl w-full max-w-md mx-4 max-h-[90vh] overflow-y-auto">
                <div className="flex items-center justify-between p-6 border-b border-border">
                    <h2 className="text-xl font-semibold text-text-primary">Add Activity</h2>
                    <Button 
                        onClick={handleClose} 
                ...
                <form onSubmit={handleSubmit} className="p-6">
                                ...
                                <button
                                    ...
                                    className={`p-3 rounded-lg border-2 transition-all ${
                                        activityType === type.value
                                            ...
                                            : 'border-border hover:border-accent-primary hover:bg-accent-primary hover:bg-opacity-5'
                                    }`}
                                >
                    ...
                    <div className="mb-4">
                        ...
                        <input
                            ...
                            className="w-full p-3 rounded-lg border border-border bg-input-bg text-text-primary focus:outline-none focus:ring-2 focus:ring-accent-primary"
                            required
                        />
                    </div>
                    ...
                    {activityType === 'journal' && (
                        <div className="mb-4">
                            ...
                            <textarea
                                ...
                                rows={4}
                                className="w-full p-3 rounded-lg border border-border bg-input-bg text-text-primary focus:outline-none focus:ring-2 focus:ring-accent-primary resize-none"
                                required
                            />
                        </div>
                    )}
