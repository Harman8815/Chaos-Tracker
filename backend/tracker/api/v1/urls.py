...
urlpatterns = [
    ...
    path(
        "subscriptions/upcoming/", SubscriptionUpcomingView.as_view(), name="subscription-upcoming"
    ),
    ...
    path(
        "ai/conversations/<int:id>/chat/stream/", AIChatStreamView.as_view(), name="ai-chat-stream"
    ),
    path(
        "ai/conversations/<int:id>/messages/", AIMessageListView.as_view(), name="ai-message-list"
    ),
    ...
    path(
        "ai/confirmations/", AIPendingConfirmationsView.as_view(), name="ai-pending-confirmations"
    ),
    # Memory
