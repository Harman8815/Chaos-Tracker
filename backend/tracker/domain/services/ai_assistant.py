...
from ...models import AIConversation, AIMessage, AIToolCall, DailyActivityAggregate, User
...
class AIAssistantService:
    ...
    def create_conversation(
        self, user: User, title: str = "", model: str = "gemini-2.5-flash"
    ) -> AIConversation:
    ...
    def list_conversations(
        self, user: User, status: str = "active", limit: int = 50
    ) -> List[AIConversation]:
...
def _create_expense(
    user: User, item: str, category: str, price: float, quantity: int = 1, date: str = None
) -> Dict:
