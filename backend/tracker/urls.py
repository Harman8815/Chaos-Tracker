from .intelligence_views import (
    MLDataSetListCreateView,
    MLDataSetDetailView,
    MLFeatureListCreateView,
    MLFeatureDetailView,
    MLDataQualityCheckListCreateView,
    MLDataQualityCheckDetailView,
    MLTransactionCategoryListCreateView,
    MLTransactionCategoryDetailView,
    MLSpendingPredictionListCreateView,
    MLSpendingPredictionDetailView,
    MLHabitConsistencyListCreateView,
    MLHabitConsistencyDetailView,
    MLGoalCompletionListCreateView,
    MLGoalCompletionDetailView,
    MLAnomalyListCreateView,
    MLAnomalyDetailView,
    MLRecommendationScoreListCreateView,
    MLRecommendationScoreDetailView,
    MLEvaluationListCreateView,
    MLEvaluationDetailView,
    MLModelVersionListCreateView,
    MLModelVersionDetailView,
    MLModelMonitoringListCreateView,
    MLModelMonitoringDetailView,
    UnifiedPersonalStateView,
    CrossDomainReasoningListCreateView,
    CrossDomainReasoningDetailView,
    RankedRecommendationListCreateView,
    RankedRecommendationDetailView,
    ...
    DailyPlanDetailView,
    WeeklyStrategyListCreateView,
    WeeklyStrategyDetailView,
    ExplanationListCreateView,
...
urlpatterns = [
    ...
    path(
        "expenses/monthly-stats/", ExpenseMonthlyStatsView.as_view(), name="expense-monthly-stats"
    ),
    ...
    # Points analytics
    path(
        "points/analytics/streaks/",
        PointsAnalyticsStreaksView.as_view(),
        name="points-analytics-streaks",
    ),
    path(
        "points/analytics/today-distribution/",
        PointsAnalyticsTodayDistributionView.as_view(),
        name="points-analytics-today-distribution",
    ),
    path(
        "points/analytics/habit-performance/7/",
        PointsAnalyticsHabitPerformance7View.as_view(),
        name="points-analytics-habit-performance-7",
    ),
    path(
        "points/analytics/habit-trend/30/",
        PointsAnalyticsHabitTrend30View.as_view(),
        name="points-analytics-habit-trend-30",
    ),
...
urlpatterns += [
    ...
    path(
        "ml/transaction-category/",
        MLTransactionCategoryListCreateView.as_view(),
        name="ml-transaction-category-list-create",
    ),
    path(
        "ml/transaction-category/<int:id>/",
        MLTransactionCategoryDetailView.as_view(),
        name="ml-transaction-category-detail",
    ),
    # Spending Prediction (P9-05)
    path(
        "ml/spending-prediction/",
        MLSpendingPredictionListCreateView.as_view(),
        name="ml-spending-prediction-list-create",
    ),
    path(
        "ml/spending-prediction/<int:id>/",
        MLSpendingPredictionDetailView.as_view(),
        name="ml-spending-prediction-detail",
    ),
    # Habit Consistency Prediction (P9-06)
    path(
        "ml/habit-consistency/",
        MLHabitConsistencyListCreateView.as_view(),
        name="ml-habit-consistency-list-create",
    ),
    path(
        "ml/habit-consistency/<int:id>/",
        MLHabitConsistencyDetailView.as_view(),
        name="ml-habit-consistency-detail",
    ),
    # Goal Completion Prediction (P9-07)
    path(
        "ml/goal-completion/",
        MLGoalCompletionListCreateView.as_view(),
        name="ml-goal-completion-list-create",
    ),
    path(
        "ml/goal-completion/<int:id>/",
        MLGoalCompletionDetailView.as_view(),
        name="ml-goal-completion-detail",
    ),
    ...
    path(
        ...
        MLRecommendationScoreListCreateView.as_view(),
        name="ml-recommendation-score-list-create",
    ),
    path(
        "ml/recommendation-score/<int:id>/",
        MLRecommendationScoreDetailView.as_view(),
        name="ml-recommendation-score-detail",
    ),
    ...
    path(
        "ml/model-version/",
        MLModelVersionListCreateView.as_view(),
        name="ml-model-version-list-create",
    ),
    path(
        "ml/model-version/<int:id>/",
        MLModelVersionDetailView.as_view(),
        name="ml-model-version-detail",
    ),
    # Model Monitoring (P9-12)
    path(
        "ml/monitoring/",
        MLModelMonitoringListCreateView.as_view(),
        name="ml-monitoring-list-create",
    ),
    path(
        "ml/monitoring/<int:id>/",
        MLModelMonitoringDetailView.as_view(),
        name="ml-monitoring-detail",
    ),
    ...
    path(
        ...
        CrossDomainReasoningListCreateView.as_view(),
        name="cross-domain-reasoning-list-create",
    ),
    path(
        "intelligence/reasoning/<int:id>/",
        CrossDomainReasoningDetailView.as_view(),
        name="cross-domain-reasoning-detail",
    ),
    # Recommendation Engine (P10-03)
    path(
        "intelligence/recommendation/",
        RankedRecommendationListCreateView.as_view(),
        name="ranked-recommendation-list-create",
    ),
    path(
        "intelligence/recommendation/<int:id>/",
        RankedRecommendationDetailView.as_view(),
        name="ranked-recommendation-detail",
    ),
    ...
    path(
        "intelligence/opportunity/<int:id>/",
    ...
    path(
        "intelligence/intervention/<int:id>/",
        InterventionDetailView.as_view(),
        name="intervention-detail",
    ),
    # Personalized Daily Plan (P10-09)
    path(
        "intelligence/daily-plan/", DailyPlanListCreateView.as_view(), name="daily-plan-list-create"
    ),
    path(
        "intelligence/daily-plan/<int:id>/", DailyPlanDetailView.as_view(), name="daily-plan-detail"
    ),
    # Weekly Strategy Generation (P10-10)
    path(
        "intelligence/weekly-strategy/",
        WeeklyStrategyListCreateView.as_view(),
        name="weekly-strategy-list-create",
    ),
    path(
        "intelligence/weekly-strategy/<int:id>/",
        WeeklyStrategyDetailView.as_view(),
        name="weekly-strategy-detail",
    ),
    # Explainable Recommendations (P10-11)
    path(
        "intelligence/explanation/",
        ExplanationListCreateView.as_view(),
        name="explanation-list-create",
    ),
    path(
        "intelligence/explanation/<int:id>/",
        ExplanationDetailView.as_view(),
        name="explanation-detail",
    ),
    # Feedback Loop (P10-12)
    path(
        "intelligence/feedback/",
        UserFeedbackListCreateView.as_view(),
        name="user-feedback-list-create",
    ),
    path(
        "intelligence/feedback/<int:id>/",
        UserFeedbackDetailView.as_view(),
